...
sudo apt-get install -y pkg-config git cmake g++ gawk m4 libuchardet-dev libxerces-c-dev libspdlog-dev libpcre3-dev libarchive-dev libssl-dev libssh-dev libsmbclient-dev libnfs-dev libx11-dev libxi-dev
...
echo "Version: 2.4" >> deb/far2l/DEBIAN/control
...
echo "Depends: libwxgtk3.0-dev | libwxgtk3.0-gtk3-dev, libuchardet-dev, libpcre3-dev, libarchive-dev, libxerces-c-dev, libspdlog-dev, libssl-dev, libssh-dev, libsmbclient-dev, libnfs-dev, libneon27-dev, libx11-dev, libxi-dev" >> deb/far2l/DEBIAN/control
